...
当前结论：**D1功能与最新26项全量测试已通过并合并**；当前进入D2。
...
命令/能力Schema机器可读版纳入D2接口固化；真实`SerialTransport`仍属于H1。
