...
> 当前状态：D0、D1、D2、D3数字阶段已完成并冻结；下一阶段进入H1真实硬件采购、到货验收和手动单点台架验证准备。本项目输出客观脉搏参数和工程验证结果，不输出脉象、证候、疾病或治疗结论。
...
D0–D3数字原型已冻结。当前进入H1首批硬件采购与台架验证准备；没有实物时不宣称H1完成。
...
当前状态是D0至D3已完成并冻结。D3正式验收绑定全部门禁、自动识别CI证据来源、配置哈希与T01–T24节点证据；main CI与`d3-v1.0.0`标记后进入H1准备：
