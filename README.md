...
> 当前状态：D0、D1已验收并合并，D2已完成本地验收、等待合并；下一阶段为D3自动施压与安全控制仿真。H1真实硬件采购等待D3通过。本项目输出客观脉搏参数和工程验证结果，不输出脉象、证候、疾病或治疗结论。
...
7. 进入当前阶段对应目录，不需要一次读完所有文档。

当前状态是D2已完成38项全量测试、API重放、前端生产构建和Web手动验收，等待合并；合并后进入D3。D3验收后，再执行：
