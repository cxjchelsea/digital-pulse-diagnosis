#!/usr/bin/env python3
"""Generate M1-P4B-B decision-persistence slice acceptance evidence."""
...
DEFAULT_REPORT = ROOT / "artifacts" / "acceptance" / "m1-p4b-b-acceptance.json"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="M1-P4B-B slice acceptance")
    parser.add_argument("--report", type=Path, default=DEFAULT_REPORT)
    args = parser.parse_args(argv)

    sys.path.insert(0, str(ROOT / "src"))
    from digital_pulse.m1_p4b_b_acceptance import ACCEPTANCE_VERSION, run_m1_p4b_b_acceptance
    ...
    if expected_head != software_commit_sha:
        ...
        return 1
    result = run_m1_p4b_b_acceptance(
