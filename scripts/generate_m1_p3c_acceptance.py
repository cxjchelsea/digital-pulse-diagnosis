#!/usr/bin/env python3
"""Generate M1-P3C backend API acceptance evidence."""
...
DEFAULT_REPORT = ROOT / "artifacts" / "acceptance" / "m1-p3c-acceptance.json"
BASELINE_SHA = "7822a54c260f61a6a19f907eecf7f8a1ca9eac2b"
P0_P1_P2_P3B_PATHS = (
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="M1-P3C formal acceptance")
    ...
    frozen = {"p0_p1_p2_p3b": _check_paths(P0_P1_P2_P3B_PATHS).as_report()}
